Rails.application.routes.draw do
...

  {
    ...
    jira: "https://auth.atlassian.com/authorize?audience=api.atlassian.com&client_id=#{Rails.application.credentials.providers.jira.app.client_id}&scope=read%3Ajira-user%20offline_access&redirect_uri=#{Rails.application.credentials.host_url}/xapp/providers/Jira/redirects/new&state=${YOUR_USER_BOUND_VALUE}&response_type=code&prompt=consent",
    heroku: "https://id.heroku.com/oauth/authorize?client_id=#{Rails.application.credentials.providers.heroku.app.client_id}&response_type=code&scope=global&state={anti-forgery-token}",
